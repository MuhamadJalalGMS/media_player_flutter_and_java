...
Color subSecondaryColor = Color(0xFFFF4268);
Color thirdColor = Color(0xFFE87D3C);
Color subThirdColor = Color(0xFFFFA542);
Color customGrey = Colors.grey[900];
Color primaryOrange = Color(0xFFf24822);
Color primaryTextColor = Color(0xFF2B0042);
Color primaryIconColor = Color(0xFFb70000);
Color primaryPurple = Color(0xFF2B0042);
