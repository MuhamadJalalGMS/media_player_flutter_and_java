            ...
            children: <Widget>[
              new AudioPlaylistComponent(
                playlistBuilder:
                  ...
                  final songTitle = _list[playlist.activeIndex].title;
                  // todo add artist name here
                  final artistName = 'MuhamadJalal';
  ...
  Widget build(BuildContext context) {
    return new AudioComponent(
      ...
      playerBuilder: (BuildContext context, AudioPlayer player, Widget child) {
        ...
        Color buttonColor = primaryIconColor;
        Function onPressed;
        ...
        return new RawMaterialButton(
          ...
          splashColor: primaryIconColor,
          highlightColor: primaryIconColor.withOpacity(0.5),
          elevation: 10.0,
