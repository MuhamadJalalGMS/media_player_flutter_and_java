...
import 'package:media_player/music_player_service/bottom_controls.dart';
import 'package:media_player/values.dart';
import 'package:meta/meta.dart';

class TrackPlayer extends StatefulWidget {
  List<TrackData> _list = List();

  TrackPlayer(this._list);

  @override
  _TrackPlayerState createState() => new _TrackPlayerState();
}
...
class _TrackPlayerState extends State<TrackPlayer> {
  ...
  Widget build(BuildContext context) {
    return new AudioPlaylist(
      playlist: widget._list.map((TrackData song) {
        return song.url;
      ...
      child: new Scaffold(
        ...
        body: new Column(
          children: <Widget>[
            ...
            new Expanded(
              child: new AudioPlaylistComponent(
                playlistBuilder:
                  ...
                  //todo track image url here
                  String albumArtUrl =
                      'assets/a.png'; //widget._list[playlist.activeIndex].trackImageUrl;

                  return new AudioRadialSeekBar(
                    //todo add image as parameter
            ...
            new BottomControls(widget._list)
          ],
        ),
      ),
    );
      ...
      child: new Container(
        ...
        child: new Center(
          ...
          child: new RadialProgressBar(
            ...
            progressColor: primaryAppColor,
            thumbPosition: thumbPosition,
            thumbColor: primaryIconColor,
